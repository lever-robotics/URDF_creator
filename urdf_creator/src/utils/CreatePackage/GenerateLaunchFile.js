export function GenerateRealLaunchFile(title) {
    return `
import os
...
export function GenerateVisualLaunchFile(title) {
    return `
import os
from ament_index_python.packages import get_package_share_directory
from launch import LaunchDescription
...
export function GenerateTestLaunchFile(title) {
    return `
import os
from ament_index_python.packages import get_package_share_directory
from launch import LaunchDescription
...
export function GenerateSimLaunchFile(title) {
    return `
import os
from ament_index_python.packages import get_package_share_directory
from launch import LaunchDescription
