...
const ExportGazeboPackage: React.FC<Props> = ({
    onClose,
    scene,
    projectTitle,
}) => {
        ...
        <div className="des-container">
            ...
            <div className="description-container">
                ...
                <p>
                    ...
                    Gazebo including a SDF file that includes simulation
                ...
                <div className="steps-container">
                    ...
                    <ol>
                        <li>
                            <strong>
                                To use this package you will also need both the{" "}
                                {projectTitle}_gazebo and {projectTitle}
                                _description
                            </strong>
                        </li>
                        <li>
                            Unzip the downloaded package, and extract the folder{" "}
                            {projectTitle}_gazebo and {projectTitle}_description
                            contained in the zip folder
                        </li>
                        <li>
                            Place the {projectTitle}_gazebo folder along side
                            the {projectTitle}_description in the src directory
                            of your ROS{" "}
                        ...
                        <div className="terminal-container">
                            <code>
                                ...
                                _gazebo {projectTitle}_description
                            </code>
                        </div>
                        ...
                        <div className="terminal-container">
                            <code>
                                ros2 launch {projectTitle}_gazebo {projectTitle}
                                .launch.py
                            </code>
                        </div>
                    </ol>
