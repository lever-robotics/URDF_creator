    ...
    return (
        <div className="des-container">
            ...
            <div className="description-container">
                <h3>Description: </h3>
                <p>
                    Robot models can be easily imported from SolidWorks using
                    the Solidworks to URDF plugin tool. Your SolidWorks
                    kinematics and dynamic properties can be ported over and
                    additional frames, sensor configurations can be prepared
                    here for simulation.
                </p>
            </div>
